...
seek.addEventListener('pointerdown', () => { isDragging = true; });
...
seek.addEventListener('change', () => { isDragging = false; commitSeek(); });
seek.addEventListener('pointerup', () => { isDragging = false; commitSeek(); });
